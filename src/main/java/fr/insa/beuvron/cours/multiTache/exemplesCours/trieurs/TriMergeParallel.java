 ...
 * @author francois
 */
public class TriMergeParallel extends Trieur implements Runnable {
     ...
     */
    protected TriMergeParallel(Trieur createur, int minIndex, int maxIndex) {
        ...
        try {
            ...
            if (max - min <= 1) {
               this.keepStatus = TrieStatus.OK;
                ...
                TriMergeParallel gauche = new TriMergeParallel(this, min, milieu);
